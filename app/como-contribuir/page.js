  ...
  return (
    <div>
      ...
      <ol className="list-decimal pl-4 mb-4">
          ...
          <li>Preenches os campos <code className="bg-gray-200 px-1 rounded">fulfilled_at</code> e <code class="bg-gray-200 px-1 rounded">links_to_news_articles</code> (lista)</li>
